...
export const PLATFORM_DEFINITIONS = [
  {
    ...
    label: "微信客服号（ClawBot）",
    description: "通过 ClawBot 连接微信，支持扫码一键绑定",
  ...
  },
  {
    ...
    description: "通过 WorkBuddy OAuth 连接微信，支持扫码绑定",
  ...
  },
  {
    ...
    label: "Telegram",
    description: "连接 Telegram Bot，需要 Bot Token",
  ...
  },
  {
    key: "feishu" as const,
    label: "飞书",
    description: "连接飞书机器人，需要 App ID 和 Secret",
  ...
  },
  {
    key: "qq" as const,
    label: "QQ 机器人",
    description: "连接 QQ 官方机器人，需要 App ID 和 Secret",
  ...
  },
  {
    key: "wework" as const,
    label: "企业微信",
    description: "连接企业微信应用，需要 Corp ID 和 Secret",
  ...
  },
  {
    ...
    label: "钉钉机器人",
    description: "连接钉钉自定义机器人，需要 Client ID 和 Secret",
