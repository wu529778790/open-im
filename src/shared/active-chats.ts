...
export function getActiveChatId(platform: 'dingtalk' | 'feishu' | 'qq' | 'telegram' | 'wework' | 'workbuddy' | 'clawbot'): string | undefined {
  return data[platform];
}

export function setActiveChatId(platform: 'dingtalk' | 'feishu' | 'qq' | 'telegram' | 'wework' | 'workbuddy' | 'clawbot', chatId: string): void {
